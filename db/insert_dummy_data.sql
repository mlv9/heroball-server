...
INSERT INTO PlayerGameStats (
    ...
    MinutesPlayed)
    VALUES 
        (1, 1, 1, 9, 20, 30, 10, 12, 2, 2, 2, 6, 2, 1, 1, 3, 2, 2, 0, 29),
        ...
        (2, 5, 1, 8, 3, 11, 2, 4, 2, 4, 2, 6, 2, 2, 2, 1, 4, 2, 1, 35),
        (3, 6, 1, 11, 1, 4, 0, 3, 0, 0, 2, 6, 0, 0, 0, 2, 1, 0, 0, 40),
        (3, 7, 1, 11, 1, 4, 0, 3, 0, 0, 2, 6, 0, 0, 0, 2, 1, 0, 0, 40),
